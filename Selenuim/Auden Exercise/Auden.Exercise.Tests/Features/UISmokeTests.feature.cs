...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute("Dress", "Highest Price", null)]
        public virtual void CreateAnAccount(string productCategory, string priceCategory, string[] exampleTags)
        {
...
#line 6
 testRunner.And("Provides an email address under create new account form and clicks the create acc" +
                    "ount button", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line 7
...
#line 11
 testRunner.When(string.Format("user selects an item category as {0} and chooses a product listed with {1} price", productCategory, priceCategory), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line 12
 testRunner.Then("user can now add selected item to basket", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line 13
 testRunner.When("user logs out, and logs back in, item should still be in the basket", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
